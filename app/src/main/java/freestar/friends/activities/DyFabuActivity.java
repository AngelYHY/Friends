...
发表说说
 */
public class DyFabuActivity extends BaseActivity
    ...
    private void initclick() {
        ...
        fabiao.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (content.length() == 0) {
                    Toast.makeText(DyFabuActivity.this, "写点东西吧！", Toast.LENGTH_SHORT).show();
                    return;
                } else {
                    //选了本地照片
                    if (data1 != null) {
    ...
    private void addNoPoInfo() {
        ...
        message.save(new SaveListener<String>() {
            ...
            public void done(String s, BmobException e) {
                if (e == null) {
                    Toast.makeText(DyFabuActivity.this, "成功", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(DyFabuActivity.this, "失败", Toast.LENGTH_SHORT).show();
                }
                DyFabuActivity.this.finish();
            }
...
//    }
    ...
    public void onClickNinePhotoItem(BGASortableNinePhotoLayout sortableNinePhotoLayout, View view, int position, String model, ArrayList<String> models) {
        startActivityForResult(BGAPhotoPickerPreviewActivity.newIntent(DyFabuActivity.this, MAX_PHOTO_COUNT, models, models, position, false), REQUEST_CODE_PHOTO_PREVIEW);
    }
