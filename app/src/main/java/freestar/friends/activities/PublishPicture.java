        ...
        switch (view.getId()) {
            ...
            case R.id.btn_publish:
                ...
                if (titleData == null || titleData.equals("")) {
                    Toast.makeText(PublishPicture.this, "标题还没输入呢", Toast.LENGTH_SHORT).show();
                } else {
                    showDL();
                }
                break;
            ...
            //xiangji
            case R.id.iv_camera:
                PublishPicturePermissionsDispatcher.showCameraWithCheck(this);
                break;
        }
    }
    ...
    private void showDL() {
        ...
        builder.setSingleChoiceItems(sex, 0, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                //这的which表示数组的下标
                kind = sex[which];
                Toast.makeText(PublishPicture.this, "类别为：" + sex[which], Toast.LENGTH_SHORT).show();
            }
        });
...
//                textView_sex.setText(sex[which]);
    ...
    private void dealEditData(List<SEditorData> editList) {
        ...
        for (int i = 0; i < editList.size(); i++) {
            ...
            if (i == 0) {
                if (inputStr != null) {
                    if (imagePath == null) {
                        Toast.makeText(PublishPicture.this, "第一行只能放图片哦", Toast.LENGTH_SHORT).show();
                        return;
                    }
                }
            }
        ...
        if (path.size() == 0) {
            Toast.makeText(PublishPicture.this, "请至少添加一张图片", Toast.LENGTH_SHORT).show();
            return;
        }
        createProgressBar();
        index = path.size();
    ...
    private void upPic() {
        ...
        BmobFile.uploadBatch(strPath, new UploadBatchListener() {
            ...
            public void onError(int statuscode, String errormsg) {
                if (statuscode == 9016) {
                    Toast.makeText(PublishPicture.this, "网络异常，发布失败", Toast.LENGTH_SHORT).show();
                    return;
                }
            }
    ...
    private void addInfo(final List<String> urls) {
        ...
        atlas.save(new SaveListener<String>() {
            ...
            public void done(String s, BmobException e) {
                if (e == null) {
                    Toast.makeText(PublishPicture.this, "成功", Toast.LENGTH_SHORT).show();
                    //添加关联
                    addAss(urls, s);
                }
            }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        PublishPicturePermissionsDispatcher.onRequestPermissionsResult(this, requestCode, grantResults);
    }
