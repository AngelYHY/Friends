...
//        if(user != null){
//            // 允许用户使用应用
//            Intent intent = new Intent(LoginActivity.this,HomePageA.class);
...
//        }
                ...
                if (e == null) {
                    if (list != null && list.size() == 1) {
                        ...
                        if (user.getPassword().equals(psw)) {
                            ...
                            Intent i2 = new Intent(LoginActivity.this, HomePageA.class);
                            startActivity(i2);
                        ...
                        Toast.makeText(LoginActivity.this, "号码并未注册", Toast.LENGTH_SHORT).show();
    ...
    public void setTvRemember() {
        Log.e("FreeStar", "LoginActivity→→→setTvRemember:");
