...
public class SearchActivity1 extends BaseActivity implements XListView.IXListViewListener, View.OnClickListener {
        ...
        query.findObjects(new FindListener<AtlasDis>() {
            ...
            public void done(List<AtlasDis> list, BmobException e) {
                if (e == null) {
                    ...
                    if (list.size() == 0) {
                        Toast.makeText(SearchActivity1.this, "没有数据了", Toast.LENGTH_SHORT).show();
                    } else {
                        mDatas.addAll(list);
                        mAdapter.notifyDataSetChanged();
                    }
            ...
            protected void convert(ViewHolder holder, final AtlasDis s, int position) {
                ...
                holder.setOnClickListener(R.id.line_reply, new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent intent = new Intent(SearchActivity1.this, DiscussActivity.class);
                ...
                holder.setOnClickListener(R.id.sdv_head, new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intent = new Intent(SearchActivity1.this, UserDataActivity.class);
