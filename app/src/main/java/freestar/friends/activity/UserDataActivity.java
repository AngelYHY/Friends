...
//        });
    ...
    public void tatypeClick(View view) {
        if (user.isTypeswitch()) {
            Intent intent = new Intent(UserDataActivity.this, MyPublishActivity.class);
...
//        });
    ...
    public void tacollectClick(View view) {
        ...
        if (user.isCollectswitch()) {
            Intent intent = new Intent(UserDataActivity.this, CollectActivity.class);
//            Bundle bundle = new Bundle();
//            bundle.putSerializable("user", user);
//            intent.putExtras(bundle);
            intent.putExtra("user", user);
...
//        });
    ...
    public void concernClick(View view) {
        if (user.isConcernswitch()) {
            Intent intent = new Intent(UserDataActivity.this, ConcernActivity.class);
//            Bundle bundle = new Bundle();
//            bundle.putSerializable("user", user);
//            intent.putExtras(bundle);
            intent.putExtra("user", user);
