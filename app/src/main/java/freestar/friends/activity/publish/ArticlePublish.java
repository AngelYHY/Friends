...
@RuntimePermissions
public class ArticlePublish extends BaseActivity {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.iv_gallery:
                ...
                break;
            case R.id.iv_camera:
                ArticlePublishPermissionsDispatcher.showCameraWithCheck(this);
                break;
        }
    }
    ...
    private void showDL() {
        ...
        builder.setSingleChoiceItems(sex, 0, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                //这的which表示数组的下标
                kind = sex[which];
                Toast.makeText(ArticlePublish.this, "类别为：" + sex[which], Toast.LENGTH_SHORT).show();
            }
        });
        ...
        BmobFile.uploadBatch(strPath, new UploadBatchListener() {
            ...
            public void onError(int statuscode, String errormsg) {
                ...
                if (statuscode == 9016) {
                    ...
                    Toast.makeText(ArticlePublish.this, "网络异常，发布失败", Toast.LENGTH_SHORT).show();
                    return;
                }
            }
...
//        ArrayList<BmobObject> picList = new ArrayList<>();
        ...
        article.save(new SaveListener<String>() {
            ...
            public void done(String s, BmobException e) {
                if (e == null) {
                    Toast.makeText(ArticlePublish.this, "成功", Toast.LENGTH_SHORT).show();
                    //添加关联
                    addInfo(s);
                }
            }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        ArticlePublishPermissionsDispatcher.onRequestPermissionsResult(this, requestCode, grantResults);
    }
