...
/**
 * Created by 28655 on 2016/8/28.
 */
public class MyTyprAdapter extends BaseAdapter {
    Context mContext;
    List<Article> mList;
    LayoutInflater mInflater;

    public MyTyprAdapter(List mList, Context mContext) {
        this.mList = mList;
