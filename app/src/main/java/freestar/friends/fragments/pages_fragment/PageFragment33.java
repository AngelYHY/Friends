 ...
 */
public class PageFragment33 extends Fragment {
        ...
        mLoadMoreWrapper.setOnLoadMoreListener(new LoadMoreWrapper.OnLoadMoreListener() {
            ...
            public void onLoadMoreRequested() {
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Log.e("FreeStar", "PageFragment33→→→run:");
                        ...
                        query.findObjects(new FindListener<Atlas>() {
                            ...
                            public void done(List<Atlas> list, BmobException e) {
                                if (e == null) {
                                    Log.e("FreeStar", "PageFragment33→→→done:" + list.size());
                                    mDatas.addAll(list);
                                    for (Atlas mData : mDatas) {
                                        Log.e("FreeStar", "PageFragment33→→→done:" + mData.toString());
                                    }
                                } else {
                                    Log.e("FreeStar", "PageFragment33→→→done:" + e.getMessage());
                                }
                            }
                        });
