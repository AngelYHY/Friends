...
public class SetupActivity extends BaseActivity {
    ...
    public void fankuiClick(View view) {
        ...
        String name ="官方客服";
        String id = "00001";
        RongIM.getInstance().startPrivateChat(SetupActivity.this, id, name);
    ...
    public void qktpClick(View view) {
        Toast.makeText(SetupActivity.this, "图片清理处理完毕", Toast.LENGTH_SHORT).show();
    }

    //搜索清理
    public void qkssClick(View view) {
        Toast.makeText(SetupActivity.this, "处理完毕xiuxiu", Toast.LENGTH_SHORT).show();
    }
