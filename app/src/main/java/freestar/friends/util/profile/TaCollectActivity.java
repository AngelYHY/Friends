...
import freestar.friends.fragments.msg_fragment.smallfragment.TaCollectShelunFragment;
import freestar.friends.fragments.msg_fragment.smallfragment.TaCollectTujiFragment;
import freestar.friends.util.status_bar.BaseActivity;

public class TaCollectActivity  extends BaseActivity implements RadioGroup.OnCheckedChangeListener,ViewPager.OnPageChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ta_collect);
        fragmentList = new ArrayList<>();
        fragmentList.add(new TaCollectShelunFragment());
        fragmentList.add(new TaCollectTujiFragment());
