...
import freestar.friends.fragments.msg_fragment.smallfragment.TaTypeshelunFragment;
import freestar.friends.fragments.msg_fragment.smallfragment.TaTyprtujiFragment;
import freestar.friends.util.status_bar.BaseActivity;


public class TaTypeActivity extends BaseActivity implements RadioGroup.OnCheckedChangeListener, ViewPager.OnPageChangeListener {
    ViewPager vp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ta_type);

        fragmentList = new ArrayList<>();
        //初始化fragment集合
        fragmentList.add(new TaTyprtujiFragment());
        fragmentList.add(new TaTypeshelunFragment());
