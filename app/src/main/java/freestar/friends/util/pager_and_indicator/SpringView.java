...
package freestar.friends.util.pager_and_indicator;
...
public class SpringView extends View {
    ...
    private github.chenupt.springindicator.Point headPoint;
    private github.chenupt.springindicator.Point footPoint;
    ...
    private void init(){
        ...
        headPoint = new github.chenupt.springindicator.Point();
        footPoint = new github.chenupt.springindicator.Point();
    ...
    public github.chenupt.springindicator.Point getHeadPoint() {
        return headPoint;
    }

    public github.chenupt.springindicator.Point getFootPoint() {
        return footPoint;
    }
