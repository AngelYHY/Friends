...
import freestar.friends.util.recycler_and_fab.recyclerview.base.ItemViewDelegateManager;
import freestar.friends.util.recycler_and_fab.recyclerview.base.ViewHolder;

/**
 * Created by zhy on 16/4/9.
 */
public class MultiItemTypeAdapter2<T> extends RecyclerView.Adapter<ViewHolder> {
    ...
    public MultiItemTypeAdapter2(Context context, List<T> datas) {
        mContext = context;
        mDatas = datas;
    ...
    public MultiItemTypeAdapter2 addItemViewDelegate(ItemViewDelegate<T> itemViewDelegate) {
        mItemViewDelegateManager.addDelegate(itemViewDelegate);
        return this;
    }

    public MultiItemTypeAdapter2 addItemViewDelegate(int viewType, ItemViewDelegate<T> itemViewDelegate) {
